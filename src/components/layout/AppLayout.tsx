...
import MobileTitleView from './MobileTitleView';
...
export default function AppLayout() {
  ...
  // Removed unused dynamic count functions - keeping only getCurrentPageTitle which is used
  ...
  return (
    <TooltipProvider>
      <div className={`h-screen flex bg-white text-gray-900 ${isMobile ? 'mobile-app-container' : ''}`}>
        ...
        {/* Mobile Title and View Toggle - positioned just above link cards */}
        {isMobile && (
          <MobileTitleView
            title={getCurrentPageTitle()}
            filteredLinksCount={filteredLinks.length}
        ...
        {/* Main Content Area */}
        <main className={`flex-1 overflow-y-auto ${isMobile ? 'pt-6 mobile-main-content mobile-scroll-container' : 'pt-8'} bg-white`}>
          {/* Bulk Actions */}
          <BulkActions
            folders={folders}
            ...
            <div className="p-6">
              <div className="mb-6 flex items-center justify-between">
                ...
                {deletedLinks.length > 0 && (
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <p>Permanently delete all links in trash</p>
                    </TooltipContent>
                  </Tooltip>
                )}
              </div>
              ...
              {deletedLinks.length === 0 ? (
                <EmptyState
                  ...
                  description="Deleted links will appear here. You can restore them or permanently delete them."
                />
              ) : (
