...
const LinkCard = memo(function LinkCard({
  ...
  return (
    ...
    >
      ...
      <div className="p-2 sm:p-3 space-y-1.5 sm:space-y-2 bg-white dark:bg-gray-800">
        {/* Folder origin badge */}
        ...
        <div className="flex items-center justify-between gap-2 min-h-[1rem]">
          {link.description && (
            <p className="text-xs sm:text-xs text-gray-700 dark:text-gray-300 line-clamp-1 flex-1">
              {highlightedDescription || link.description}
            </p>
          )}
          {link.tags && link.tags.length > 0 && (
            <Badge variant="secondary" className="text-xs px-1.5 sm:px-2 py-0.5 sm:py-1 shrink-0 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center justify-center w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-blue-50 dark:bg-gray-700 border border-blue-100 dark:border-gray-600">
            {getPlatformIcon(platform, 'h-3 w-3 sm:h-4 sm:w-4 text-blue-600 dark:text-blue-400')}
          </div>
