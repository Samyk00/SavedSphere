...
const LinkCard = memo(function LinkCard({
  ...
  return (
    <div
      className="group relative overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1 shadow-md cursor-pointer border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-750 focus-ring"
      onClick={(e) => {
      ...
      onKeyDown={(e) => {
        if (e.key === 'Enter' || e.key === ' ') {
          e.preventDefault();
          // Don't open if focusing on interactive elements
          if ((e.target as HTMLElement).closest('button')) {
            return;
          }
          handleCardClick();
    ...
    >
      ...
      <div className="relative w-full h-24 sm:h-32 bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-700 dark:to-gray-800 rounded-t-lg overflow-hidden">
      ...
      <div className="p-2 sm:p-3 space-y-1 sm:space-y-1.5 md:space-y-2 bg-white dark:bg-gray-800">
        {/* Folder origin badge */}
        {showFolderOrigin && folderName && (
          <div className="flex items-center">
            <Badge variant="outline" className="text-xs px-1.5 sm:px-2 py-0.5 sm:py-1 bg-blue-50 dark:bg-blue-900/30 border-blue-200 dark:border-blue-700 text-blue-700 dark:text-blue-300">
              📁 {folderName}
            </Badge>
          </div>
        )}
        ...
        <h3 className="font-semibold text-xs sm:text-sm line-clamp-1 leading-tight text-gray-900 dark:text-gray-100">
        ...
        <div className="flex items-center justify-between gap-2 min-h-[1rem]">
          ...
          {link.tags && link.tags.length > 0 && (
            <Badge variant="secondary" className="text-xs px-1.5 py-0.5 shrink-0 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center justify-center w-5 h-5 rounded-full bg-blue-50 dark:bg-gray-700 border border-blue-100 dark:border-gray-600 shadow-sm">
            {getPlatformIcon(platform, 'h-3 w-3 text-blue-600 dark:text-blue-400')}
          </div>
