...
export default function LinkGrid({
  ...
  return (
    <div className="px-4 pb-4 pt-6 bg-white md:px-6 md:pb-6 md:pt-12">
      {/* Results count - hidden since it's now shown in SearchBar */}

      {/* Grid */}
      <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-2 sm:gap-3 md:gap-6">
        {isLoading ? (
