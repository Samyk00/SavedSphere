...
export default function LinkList({
  ...
  return (
    <div className="px-4 pb-4 pt-6 bg-gray-50 dark:bg-gray-900 md:px-6 md:pb-6 md:pt-12">
      {/* Compact List */}
                ...
                <div className="flex items-center gap-1 flex-shrink-0">
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      ...
                      {(!bulkSelectMode || (bulkSelectMode && selectedLinkIds.has(link.id))) && (
                        <>
                          <DropdownMenuItem
                            onClick={() => {
                              if (!bulkSelectMode) {
                          ...
                          >
                            ...
                            {bulkSelectMode && selectedLinkIds.has(link.id) ? 'Deselect' : 'Select'}
                          </DropdownMenuItem>
                          <DropdownMenuSeparator />
                        </>
                      )}
